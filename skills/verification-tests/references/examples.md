      ...
      "p1": {
        ...
        "items_by_key": {
          ...
          "setup": {
            ...
            "steps_by_key": {
              "launch": {
                ...
                "finish_condition": [
                  { "check": "a 'Login' button and an SSO button are both visible." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
                    "description": "",
              ...
              "failed-login": {
                ...
                "finish_condition": [
                  { "check": "An error message is shown and you remain on the login screen (not logged in)." }
                ],
                "hint_manual": []
              },
              "login": {
                ...
                "finish_condition": [
                  { "check": "The main menu is shown after successfully logging in." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
                    "description": "",
          ...
          "open_settings": {
            ...
            "finish_condition": [
              { "check": "The Settings screen is open." },
              { "check": "The screen header text reads \"SETTINGS\"." },
              { "check": "A back button is visible in the top-left corner." }
            ],
            "hint_manual": []
          },
          ...
          "settings_sections": {
            ...
            "finish_condition": [
              { "check": "The tab labels ACCOUNT, SECURITY, LANGUAGE, NOTIFICATIONS, and PAYMENTS are each visible." },
              { "check": "A version number and a build number are shown in the footer." }
            ],
            "hint_manual": []
          }
        },
          ...
          "setup": {
            ...
            "steps_by_key": {
              "launch": {
                ...
                "finish_condition": [
                  { "check": "The login screen is shown with a 'Login with nexus' button visible." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
              ...
              "login": {
                ...
                "finish_condition": [
                  { "check": "After submitting, the project-select screen is shown." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
              ...
              "select_project": {
                ...
                "finish_condition": [
                  { "check": "The 'Playground' project dashboard is open." }
                ],
                "hint_manual": []
              }
            },
          ...
          "test_repository": {
            ...
            "steps_by_key": {
              "create": {
                ...
                "finish_condition": [
                  { "check": "A test named 'Daily Smoke Test Creation 1' appears in the Repository list." }
                ],
                "hint_manual": []
              },
              "update": {
                ...
                "finish_condition": [
                  { "check": "Reopening the test shows 'Level 0 loads' as step 1's expected result." }
                ],
                "hint_manual": []
              },
              "move": {
                ...
                "finish_condition": [
                  { "check": "The test appears inside the 'Daily Smoke Test' folder." }
                ],
                "hint_manual": []
              },
              "delete": {
                ...
                "finish_condition": [
                  { "check": "The test no longer appears in the Repository." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
          ...
          "build_storage": {
            ...
            "steps_by_key": {
              "upload": {
                ...
                "finish_condition": [
                  { "check": "A build named 'Smoke Check Test Upload' appears in Build Storage." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
              ...
              "manage": {
                ...
                "finish_condition": [
                  { "check": "View Build Details opens a popup showing the build's details." },
                  { "check": "After choosing Pin build, the build is shown as pinned." },
                  { "check": "Clicking the pencil icon opens an Edit Build popup." }
                ],
                "hint_manual": []
              },
              "delete": {
                ...
                "finish_condition": [
                  { "check": "The build no longer appears in Build Storage." }
                ],
                "hint_manual": [
                  { "hint_key_regex": ".*",
                    "description": "Delete guardrail",
